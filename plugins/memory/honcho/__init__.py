...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            # Prevent peer fragmentation: DON'T override peer_name with gateway user_id.
            # The gateway user_id (e.g. Telegram chat ID) was creating a separate
            # peer from CLI sessions which use the configured peerName.
            # Keep the configured peerName — it's the real identity.
